      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-white/80 max-w-2xl mx-auto">
            Pronto para levar seu negócio online? Entre em contato conosco hoje
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-white/80 leading-relaxed mb-8">
                Estamos aqui para ajudar a dar vida à sua visão. Seja para um
                novo site, redesign de um existente, ou dúvidas sobre nossos
                serviços, adoraríamos ouvir de você.
              </p>
            </div>
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <a
                    target="blank"
                    href="https://www.instagram.com/bloo_code/"
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <a
                    href="https://wa.me/5598991102463"
                    target="_blank"
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-white/80">Seg - Sex: 8h - 18h</p>
                </div>
              </div>
            </div>
          </div>
